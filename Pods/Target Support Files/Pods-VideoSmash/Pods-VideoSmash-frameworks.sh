...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TextFieldFormatter/TextFieldFormatter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZoomingTransition/ZoomingTransition.framework"
